...
var mode_inc = func {
	...
	if (mode == "APP") {
		...
		setprop("/instrumentation/efis/inputs/plan-wpt-index",getprop("autopilot/route-manager/current-wp"));
...
var mode_inc2 = func {
	...
	if (mode == "APP") {
		...
		setprop("/instrumentation/efis[1]/inputs/plan-wpt-index",getprop("autopilot/route-manager/current-wp"));
